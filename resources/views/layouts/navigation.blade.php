...
<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="images/logo_2.png" alt="" style="width: 50px; height: 50px;">

                    </a>
                </div>
                <div class="shrink-0 flex items-center">
                    <h1 class="logo">Bibaho-Bangla</h1>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link :href="route('setinfo')" :active="request()->routeIs('setinfo')">
                        {{ __('Biodata') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('setinfo')" :active="request()->routeIs('setinfo')">
                        {{ __('Biodata') }}
                    </x-responsive-nav-link>
                    <x-nav-link :href="route('stories')" :active="request()->routeIs('stories')">
                        {{ __('Stories') }}
